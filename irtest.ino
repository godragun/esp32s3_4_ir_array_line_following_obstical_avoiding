...
const float WALL_DISTANCE = 8.0;  // Wall detection distance
const float FRONT_SAFE_DISTANCE = 8.5;  // Safe distance from front wall
const int BASE_SPEED = 50;  // Reduced base speed for better control
const int FAST_SPEED = 60;  // Fast speed for open passages
...
const double Ki_line = 0.15;  // Small integral gain for stability
const double Kd_line = 0.8;   // Derivative gain for damping
const int BASE_SPEED_LINE = 93;   // Base speed for line following
const int MAX_SPEED_LINE = 100;   // Maximum speed for line following
